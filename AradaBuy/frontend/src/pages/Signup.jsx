  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      ...
      <div className="w-full md:w-1/2 max-w-md bg-white rounded-xl shadow-md p-8">
        <h2 className="text-xl font-semibold text-gray-800 mb-2">Hello, Welcome to AradaBuy</h2>
        <p className="text-gray-500 text-sm mb-6">Create account to get our full service</p>
        ...
        <div className="mt-6 text-center text-sm">
          <p className="text-gray-600">
            ...
            <Link to="/login" className="font-medium text-[#CE542C] hover:underline">
              Sign in
            </Link>
          </p>
          <div className="mt-4">
